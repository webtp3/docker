...
RUN php composer.phar --dev --stability=dev create-project web-tp3/tp3_installer:dev-8.x-dev typo3
#ADD .htaccess  /var/www/html/web/
VOLUME [ "/var/www/typo3/web/uploads", "/var/www/typo3/web/fileadmin" ,"/var/www/html/web/error" ]
...
ADD AdditionalConfiguration.php /var/www/typo3/web/typo3conf/
# Install dependencies defined in composer.json
#ADD composer.json /var/www/typo3/
#RUN cp /var/www/typo3/web/typo3conf/ext/typo3_console/Scripts/typo3cms/* /var/www/typo3/
#apache
EXPOSE 80
#ssh
EXPOSE 22
